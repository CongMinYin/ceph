...
static std::vector<Option> get_immutable_object_cache_options() {
  return std::vector<Option>({
    ...
    Option("immutable_object_cache_qos_iops_burst_seconds", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("immutable object cache qos iops burst seconds"),
    ...
    Option("immutable_object_cache_qos_bps_burst_seconds", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_default(1)
    .set_description("immutable object cache qos bps burst seconds"),
  });
}
